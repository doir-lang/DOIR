...
namespace doir {
	...
	#define PUSH_CALL_BODY(PUSH_COMMON_FN, COMPONENT_TYPE, VECTOR_TYPE,\
							 FUNCTION_VALUE, ARGUMENTS)\
		auto out = PUSH_COMMON_FN;\
	...
	ecrs::entity_t block_builder::push_call(interned_string name, ecrs::entity_t type, ecrs::entity_t function, std::span<ecrs::entity_t> arguments){
		PUSH_CALL_BODY(push_common(mod, block, name, type), function_inputs, std::vector<ecrs::entity_t>, function, arguments);
	}

	ecrs::entity_t block_builder::push_call(interned_string name, interned_string type_lookup, ecrs::entity_t function, std::span<ecrs::entity_t> arguments){
		PUSH_CALL_BODY(push_common_lookup(mod, block, name, type_lookup), function_inputs, std::vector<ecrs::entity_t>, function, arguments);
	}
	...
	ecrs::entity_t block_builder::push_call(interned_string name, ecrs::entity_t type, interned_string function_lookup, std::span<lookup::lookup> arguments){
		PUSH_CALL_BODY(push_common(mod, block, name, type), lookup::function_inputs, std::vector<lookup::lookup>, function_lookup, arguments);
	}

	ecrs::entity_t block_builder::push_call(interned_string name, interned_string type_lookup, interned_string function_lookup, std::span<lookup::lookup> arguments){
		PUSH_CALL_BODY(push_common_lookup(mod, block, name, type_lookup), lookup::function_inputs, std::vector<lookup::lookup>, function_lookup, arguments);
	}
	...
	ecrs::entity_t block_builder::push_call(interned_string name, ecrs::entity_t type, ecrs::entity_t function, std::span<lookup::lookup> arguments){
		PUSH_CALL_BODY(push_common(mod, block, name, type), lookup::function_inputs, std::vector<lookup::lookup>, function, arguments);
	}

	ecrs::entity_t block_builder::push_call(interned_string name, interned_string type_lookup, ecrs::entity_t function, std::span<lookup::lookup> arguments) {
		PUSH_CALL_BODY(push_common_lookup(mod, block, name, type_lookup), lookup::function_inputs, std::vector<lookup::lookup>, function, arguments);
	}
