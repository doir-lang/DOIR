...
namespace doir {
	...
	void module::substitute_entity(ecrs::entity_t range, ecrs::entity_t to_find, ecrs::entity_t to_replace) {
		auto s = doir::system::sorted(range, [to_find, to_replace](ecrs::context& ctx, ecrs::entity_t subtree) -> bool {
			auto& mod = (module&)ctx;
	...
	void module::substitute_entities(ecrs::entity_t range, const std::unordered_map<ecrs::entity_t, ecrs::entity_t>& substitutions) {
		...
		substitute_entity(range, to_find, to_replace);
	}
}
